...
- 🔭 I’m currently working on: Full-stack projects using **Next.js**, **React**, and **Node.js**  
- 🌱 I’m currently learning: Backend development with **Node.js**, **Express**, **MongoDB**, and exploring **SSR** and **CSR** with **Next.js**  
- 👯 I’m looking to collaborate on: **Frontend** and **full-stack projects**, especially those using **React** and **Next.js**  
- 💬 Ask me about: **React**, **Next.js**, **JavaScript**, **UI/UX development**, or anything **frontend**!  
- 📫 How to reach me: [LinkedIn](https://www.linkedin.com/in/abdullah-abd-5a6688166/)  
- ⚡ Fun fact: I enjoy turning complex problems into simple, beautiful interfaces with **React** and **Next.js**.
...
- **Frontend:** React.js, Next.js, JavaScript (ES6+), HTML5, CSS3, Bootstrap, MUI  
- **Tools & Platforms:** Git, GitHub, VS Code, Figma  
- **Learning:** Node.js, Express.js, MongoDB, Server-side Rendering (SSR), Client-side Rendering (CSR)
...
<!--
**Abdullah-abd/Abdullah-abd** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
